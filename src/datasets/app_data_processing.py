...
Note: this script fakes screen data (assumes portrait mode & iPhone 13 Pro)

Sample usage: run `python app_data_processing.py --dir  ../../data/app_data --out_dir ../../data/processed_data --threads 1` in terminal
'''
...
def extract_data(dirs, out_root): 
    ...
    for directory in tqdm(dirs):
        ...
        # shutil.copy(directory+'screen.json', out_root+'/screen.json') # screen.json "faked" by program, not outputted by app right now, use in future
